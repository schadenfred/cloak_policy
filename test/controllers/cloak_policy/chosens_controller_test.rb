...
#         post chosens_url, params: { chosen: { advice: @chosen.advice, choice_id: @chosen.choice_id, recommendation_id: @chosen.recommendation_id } }
#       end
...
#       patch chosen_url(@chosen), params: { chosen: { advice: @chosen.advice, choice_id: @chosen.choice_id, recommendation_id: @chosen.recommendation_id } }
