...
module CloakPolicy
  ...
  describe Platform do
    ...
    describe "db" do
      specify "columns" do
        wont have_db_column(:category).of_type(:integer)
        must have_db_column(:description).of_type(:string)
        must have_db_column(:domain)
    ...
    specify "associations" do
      must have_many :domains# frozen_string_literal: true
      ...
      describe Platform do
        ...
        specify "associations" do
          must have_many :domains
          must have_many :recommendations
          must have_many :settings# frozen_string_literal: true
          ...
          describe Platform do
            ...
            describe "chart-data" do
              Given(:setting) { settings(:class PlatformTest < ActiveSupport::TestCase
                # test "the truth" do
                #   assert true
                # end
              ende, 2 }
